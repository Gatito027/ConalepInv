...
export default function RestablecerPasswordModal({ usuarioId, setShowModal }) {
  ...
  const [oldPaswword, setOldPassword] = useState("");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        _password: password,
        _oldPassword: oldPaswword,
      };
      const response = await MethodPost(payload, "restablecer-password");
            ...
            <fieldset className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                />
                {(isPasswordFocused || oldPaswword.length > 0) && (
                  <button
                    type="button"
